...
public class NewsInfo
{
    ...
    public class Item
    {
        ...
        [XPath("//span[contains(@class, 'topic_info')]/strong/a")]
        [SkipNodeNotFound]
        public string? UserName { get; init; }

        [XPath("//span[contains(@class, 'topic_info')]/strong/a", "href")]
        [SkipNodeNotFound]
        public string? UserLink { get; init; }


        [XPath("//span[contains(@class, 'topic_info')]/strong/preceding-sibling::text()")]
        [SkipNodeNotFound]
